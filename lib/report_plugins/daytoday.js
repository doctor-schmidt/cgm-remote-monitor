...
daytoday.report = function report_daytoday (datastorage, sorteddaystoshow, options) {
  ...
  if (options.insulindistribution) {
    var html = '<br><br><b>' + translate('Total Daily Dose of bolus insulin (average)') + ':</b>&nbsp; ' + tddAverage.toFixed(1) + '&nbsp;U&nbsp; ';
    html += '<b>' + translate('debug') + ':</b> ' + tddSum + '%&nbsp; ';
    html += '<b>' + translate('debug') + ':</b> ' + datastorage.alldays + '%&nbsp; ';
